...
def main():
    ...
    with tf.Session() as sess:
        model = createModel(sess,False,vocab_sizech,vocab_sizeen)
        ...
        source_test_file_path = 'Ctraintest.zh'
        target_test_file_path = 'Etraintest.en'
            ...
            if current_step % steps_per_checkpoint == 0:
                ...
                for bucket_id in xrange(len(_buckets)):
                    ...
                    if datautil.EOS_ID in outputs:
                        print("输入", datautil.ids2texts(reversed([ch[0] for ch in encoder_inputs]), rev_vocabch))
                        print("输出", datautil.ids2texts([ch[0] for ch in decoder_inputs], rev_vocaben))
